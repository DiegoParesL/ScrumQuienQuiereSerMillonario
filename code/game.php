...

    {
        ...
        foreach ($preguntas_escogidas as $key => $value) {
            ...
            if ($preguntas_restantes == $total) {
                ...
                $pregunta_seleccionada = substr($key, 1); 
                ...
                foreach ($preguntasConImagenes as $pregunta => $ruta_imagen) {
                    
                    //echo "<p>" . $preguntasConImagenes[$pregunta]. "</p>";
                    if($pregunta_seleccionada === $pregunta){
                        ...
                        echo "<h2>" . $pregunta_seleccionada . "</h2>"; // Quita el signo "*" en el título
