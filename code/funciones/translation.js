...
function changeLanguage(lang) {
    ...
    const languageData = {
        ...
        'catalan': {
            ...
            'loginForm' : 'Iniciar Sesio',
            'logoutButton' : 'Tancar Sesio',
            'createForm':'Crear Preguntes'
        },
        'english': {
    ...
    document.getElementById('loginForm').textContent = languageData[lang]['loginForm'];
    document.getElementById('logoutButton').textContent = languageData[lang]['logoutButton'];
    document.getElementById('createForm').textContent = languageData[lang]['createForm'];
