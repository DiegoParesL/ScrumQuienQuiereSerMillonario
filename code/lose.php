...
<body>
    ...
    ?>
    <script>
document.getElementById("publicar").addEventListener("submit", function(event) {
    event.preventDefault(); // Previene la acción predeterminada del formulario para evitar el envío directo

    // Obtén el nombre del formulario
    var nombre = document.getElementById("nombre").value;

    // Simula el envío del formulario con una redirección a la misma página
    window.location.href = "lose.php";

    // Puedes añadir aquí una lógica para enviar los datos a través de AJAX si lo prefieres
    // y luego redirigir a la misma página después del envío exitoso
});
</script>
</body>
</html>